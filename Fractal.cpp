...
int main(int argc, char* argv[])
{
	...
	myBitmap bmp;
	bmp.create(800, 600);
	bmp.setPenColor(RGB(180, 50, 220));

	fractalTree tree;
	tree.create(&bmp);

	BitBlt(GetDC(GetConsoleWindow()), 10, 60, 800, 600, bmp.getDC(), 0, 0, SRCCOPY);

	cin >> wait;

	bmp.saveBitmap("C:\\Users\\1\\Desktop\\tree.bmp");
